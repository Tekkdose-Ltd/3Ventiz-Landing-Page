      ...
      <div className="rounded-[2rem] primary-darkbg p-8">
        <div className="grid md:grid-cols-[350px_1fr] gap-8 md:gap-32">
          <div className="text-left grid gap-8">
            ...
            <p className="text-[1.4rem] leading-[20px] max-w-[290px] w-full text-white ">
          ...
          <div className="grid sm:grid-cols-3 gap-8">
            <div>
              <p className="font-medium text-[1.6rem] leading-[28px] opacity-[0.6] text-white">
                COMPANY
              </p>
            ...
            <div>
              <p className="font-medium text-[1.6rem] leading-[28px] uppercase opacity-[0.6] text-white">
                Solutions
              </p>
              <ul className="mt-6 space-y-4">
                <li>
        ...
        />
        <p className="text-[14px] text-white text-left mt-8">
...
const FooterText = ({ text }) => {
  return (
    <p className="font-medium text-[1.6rem] leading-[28px]  text-white">
      {text}
    </p>
  );
};
