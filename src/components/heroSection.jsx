...
export default function HeroSection({ click }) {
  ...
  return (
    <section className="p-8 mt-[3.5rem] xs:mt-[5.5rem] md:mt-[7.5rem]">
      {isOpen && <Success close={() => modalFunction()} />}
      <div
        style={{ backgroundImage: `url(${hero})`, backgroundSize: "100% 100%" }}
        className="relative bg-no-repeat h-[62rem] hidden md:block  sm:h-[71.3rem] w-full rounded-[1.6rem]"
      >
        <div className="Container !pb-0 mb-8 pt-28">
          <div className="absolute left-0 p-4 sm:p-0 xs:!pr-4  bottom-12 sm:left-12 mx-auto md+:max-w-[60rem] w-full">
            {/* <img data-aos="zoom-in-up" src={calender} alt="calender logo" className="absolute top-[4rem] left-[-6rem]  sm:left-[2rem]  z-[1000]" /> */}

            <div className="grid gap-8 ">
              <p
                data-aos="zoom-in-up"
                className="strong font-normal  text-[4rem] md+:text-[6.4rem]  text-white leading-[4rem] md+:leading-[7rem]"
              >
                Plan Memorable Events with Ease
              </p>
              <p
                data-aos="zoom-in-up"
                className="md+:max-w-[42rem] w-full leading-[2rem] text-[1.4rem] xl:text-[2rem] xl:leading-[3rem] text-white"
              >
      ...
      <div
        ...
        className="relative bg-no-repeat h-[62rem] hidden xs:block md:hidden  sm:h-[71.3rem] w-full rounded-[1.6rem]"
      >
        <div className="Container !pb-0 mb-8 pt-28">
          <div className="absolute left-0 p-4 sm:p-0 xs:!pr-4  bottom-12 sm:left-12 mx-auto md+:max-w-[60rem] w-full">
            {/* <img data-aos="zoom-in-up" src={calender} alt="calender logo" className="absolute top-[4rem] left-[-6rem]  sm:left-[2rem]  z-[1000]" /> */}
            ...
            <div className="grid gap-8 ">
              ...
              <p
                data-aos="zoom-in-up"
                className="md+:max-w-[42rem] w-full leading-[2rem] text-[1.4rem] text-white"
              >
                Discover reliable vendors, manage your budget, and plan your
                events seamlessly—all in one platform designed to simplify your
                experience.
      ...
      <div
        ...
        className="relative bg-no-repeat h-[62rem] block xs:hidden  sm:h-[71.3rem] w-full rounded-[1.6rem]"
      >
        <div className="Container !pb-0 mb-8 pt-28">
          <div className="absolute left-0 p-4 sm:p-0 bottom-12 sm:left-12 mx-auto md+:max-w-[60rem] w-full">
            {/* <img data-aos="zoom-in-up" src={calender} alt="calender logo" className="absolute top-[4rem] left-[-6rem]  sm:left-[2rem]  z-[1000]" /> */}
...
const InputContainer = ({ open }) => {
  ...
  return (
    <div
      ...
      data-aos="zoom-in-up"
      className="grid grid-cols-2 xs:flex items-center xs:gap-2 justify-between max-w-[35rem] w-full rounded-full p-2 xs:pl-[1.6rem] border mt-4 "
    >
      <input
        type="email"
        name="email"
